                    ...
                    <section class="panel">
                        ...
                        <div>
                         <?php
                            ...
                            if($message){
                                echo '<span class="noti">'.$message.'</span>';
                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="slug_category_product" class="form-control" id="exampleInputEmail1" placeholder="Tên danh mục" required>
                                </div>
                                <div class="form-group">
